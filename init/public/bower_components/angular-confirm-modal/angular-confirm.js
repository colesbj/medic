...
angular.module('angular-confirm', ['ui.bootstrap.modal'])
  ...
  .value('$confirmModalDefaults', {
    ...
    '<button class="btn btn-default" ng-click="ok()">{{data.ok}}<img class="btnimage" src="/images/red.png"></img></button>' +
    '<button class="btn btn-default" ng-click="cancel()">{{data.cancel}}<img class="btnimage" src="/images/blue.png"></img></button>' +
    '</div>',
